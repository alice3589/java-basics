...
Javaの基礎をゼロから体系的に学べる学習用Webサイトです。**ブラウザ上でコードを書いて実行・自動採点**しながら学べます。自分の勉強用に作成しました。
...
- 📂 **部門ごとのページ構成** — 入門 / 制御構文 / オブジェクト指向 / 実践 / 資料 に分割
...
| `practice.html` | 実践：例外処理 / コレクション / 文字列 / ファイルI/O / ラムダ・Stream |
| `reference.html` | 資料：プレイグラウンド / チートシート / 用語集 |
